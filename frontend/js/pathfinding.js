...
async function fetchAndShowNodes() {
    ...
    try {
        ...
        if (data.nodes && data.nodes.length > 0) {
            // --- FIX: Invert Y-coordinate for correct display ---
            // The backend uses an inverted Y-axis (7801 - y). The /nodes endpoint returns raw DB coordinates.
            // We need to invert the Y-coordinate here to match the display of the path.
